...
router.get('/', function(req, res) {
  ...
  let contenido =  [
    ...
    { titulo: 'Tareas', descripcion: 'Ejemplo típico de lista de tareas (ToDo) respaldado por un API Rest.', imagen: nuevas ? 'https://picsum.photos/640/480?random=7' : 'https://placeimg.com/640/480/nature', enlace: '/todo', boton: 'Mostrar' },
