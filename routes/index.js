...
router.get('/', function(req, res, next) {
  res.render('index', { title: 'Entorno de pruebas Web4Testing', baseUrl: req.path, contenido:  [
    ...
    { titulo: 'Contactos', descripcion: 'Sistema CRUD completo que permite las pruebas de acceso a datos, paginación, trabajo con formularios y validaciones. Las consultas se pueden realizar sin estar autenticado, pero para añadir, modificar y borrar es necesaria la autenticación.', imagen: 'https://placeimg.com/640/480/nature', enlace: '/biblioteca', boton: '' },
    { titulo: 'API Rest', descripcion: 'Conjunto de servicios REST completos para servir de back-end y mock de las pruebas de las conexiones AJAX de las aplicaciones front-end. Permite la autenticación JWT.', imagen: 'https://placeimg.com/640/480/arch', enlace: '/api', boton: 'Mostrar galería' },
    { titulo: 'Ficheros', descripcion: 'Entorno de sencillo de pruebas para subir ficheros a un servidor.  Permite eliminar los ficheros subidos.', imagen: 'https://placeimg.com/640/480/tech/sepia', enlace: '/fileupload', boton: '' },
    { titulo: 'Alertas', descripcion: 'Entorno de pruebas para los tres tipos nativos de mensajes emergentes ofrecidos por JavaScript: alertas, prompts y confirmaciones, así como los cuadros modales y modeless.', imagen: 'https://placeimg.com/640/480/animals', enlace: '/alertas', boton: '' },
  ]});
});
