...
router.get('/', function(req, res, next) {
  res.render('index', { title: 'Entorno de pruebas Web4Testing', baseUrl: req.path, contenido:  [
    ...
    { titulo: 'Biblioteca', descripcion: 'Sistema CRUD completo que permite las pruebas de acceso a datos, paginación, trabajo con formularios y validaciones.', imagen: 'http://placeimg.com/640/480/nature', enlace: '/biblioteca', boton: '' },
    ...
    { titulo: 'Ficheros', descripcion: 'Entorno de sencillo de pruebas para subir ficheros a un servidor.', imagen: 'http://placeimg.com/640/480/tech/sepia', enlace: '/fileupload', boton: '' },
