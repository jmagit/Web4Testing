...
router.get('/', function(req, res) {
  ...
  let contenido =  [
    ...
    { titulo: 'Contactos', descripcion: 'Sistema CRUD completo que permite las pruebas de acceso a datos, paginación, trabajo con formularios y validaciones.', imagen: nuevas ? 'https://picsum.photos/640/480?random=3' : 'https://placeimg.com/640/480/nature', enlace: '/contactos', boton: '' },
